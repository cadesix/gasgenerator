...
async function PUT(request, { params }) {
    try {
        ...
        const project = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].project.update({
            where: {
                id
            },
            data: {
...
async function DELETE(request, { params }) {
    try {
        const { id } = await params;
        // Soft delete
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].project.update({
            where: {
                id
            },
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f6967ac3._.js.map