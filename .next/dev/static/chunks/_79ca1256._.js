...
"[project]/components/projects/ProjectForm.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProjectForm({ initialData, isEditing = false }) {
    ...
    const [examples, setExamples] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialData ? JSON.parse(initialData.examples) : [
        ''
    ]);
...
_s(ProjectForm, "zUd9Nn207kYKXEEcfXDRXVDo0Dk=", false, function() {
    return [
...
//# sourceMappingURL=_79ca1256._.js.map